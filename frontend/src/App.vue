            ...
            <div class="z-[99999] fixed inset-0 flex items-end justify-end p-6 px-4 py-6 pointer-events-none">
                <div class="w-full">
                    ...
                    <Notification v-slot="{ notifications, close }" enter="transform ease-out transition"
                        ...
                        <div v-for="notification in notifications" :key="notification.id">
                            <!-- UPLOADED FILES -->
                            <div v-if="notification.type === 'uploaded_info'"
                                class="flex w-fit min-w-[25rem] ml-auto mt-4 overflow-hidden bg-white rounded-lg shadow-md pointer-events-auto" id="uploaded_alert">
                                ...
                                <div class="w-full">
                                    <div class="relative">
                                        ...
                                        <div class="pb-3 px-4 max-h-[300px] overflow-y-auto" v-if="uploaded_success_open">
                                            <div class="flex flex-col gap-2" v-html="notification.text"></div>
                                        </div>
